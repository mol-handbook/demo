...
;
	($.$demo_scenes) = class $demo_scenes extends ($.$mol_page) {
		scenes(){
			return [];
		}
		body(){
...
var $;
(function ($) {
    $mol_style_attach("demo/scenes/scenes.view.css", "[demo_scenes_body_content] {\n\tpadding: 0;\n\tmargin: 0;\n}\n");
})($ || ($ = {}));
...
;
	($.$demo_scene) = class $demo_scene extends ($.$mol_view) {
		scene(){
			return null;
		}
		sub(){
...
(function ($) {
    var $$;
    (function ($$) {
        class $demo_scene extends $.$demo_scene {
            sub() {
                let sub = super.sub();
...
;
	($.$demo_mol_button) = class $demo_mol_button extends ($.$demo_scenes) {
		Major(){
	...
	($mol_mem(($.$demo_mol_button.prototype), "Major"));
	($mol_mem(($.$demo_mol_button.prototype), "Major_scene"));
	($mol_mem(($.$demo_mol_button.prototype), "Major_disabled"));
	($mol_mem(($.$demo_mol_button.prototype), "Major_disabled_scene"));
	($mol_mem(($.$demo_mol_button.prototype), "click_action"));
	($mol_mem(($.$demo_mol_button.prototype), "Major_click"));
	...
	($mol_mem(($.$demo_mol_button.prototype), "Download"));
	($mol_mem(($.$demo_mol_button.prototype), "Download_scene"));
	($mol_mem(($.$demo_mol_button.prototype), "Open"));
	($mol_mem(($.$demo_mol_button.prototype), "Open_scene"));
	($mol_mem(($.$demo_mol_button.prototype), "Share_link"));
	($mol_mem(($.$demo_mol_button.prototype), "Share_link_scene"));
	($mol_mem(($.$demo_mol_button.prototype), "Share_screenshot"));
	($mol_mem(($.$demo_mol_button.prototype), "Share_screenshot_scene"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $demo_mol_button.prototype, "image_blob", null);
        $$.$demo_mol_button = $demo_mol_button;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));

;
	($.$demo_mol) = class $demo_mol extends ($.$demo_scenes) {
		Button(){
			const obj = new this.$.$demo_mol_button();
			return obj;
		}
		scenes(){
			return [(this.Button())];
	...
	($mol_mem(($.$demo_mol.prototype), "Button"));
...
;
	($.$demo) = class $demo extends ($.$demo_scenes) {
		Theme(){
			const obj = new this.$.$mol_theme_auto();
			return obj;
		}
		Mol(){
			const obj = new this.$.$demo_mol();
			return obj;
		}
		plugins(){
			return [(this.Theme())];
	...
	($mol_mem(($.$demo.prototype), "Theme"));
	($mol_mem(($.$demo.prototype), "Mol"));
...
var $;
(function ($) {
    $mol_style_attach("demo/demo.view.css", ":root {\n\t-webkit-tap-highlight-color: transparent;\n}\n\n[demo_body] {\n\tmargin: var(--mol_gap_block);\n}\n");
})($ || ($ = {}));
